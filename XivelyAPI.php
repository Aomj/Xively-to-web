...
class PachubeAPI
{
	...
	{	
		...
		$url = "http://$this->xively/feeds/$feed?";
		if($datastreams)
		{
	...
	public function getDatastream($format=false, $feed, $datastream)
	{
		...
		$url = "http://$this->Xively/feeds/$feed/datastreams/$datastream";
	...
	public function getUser($format=false, $user)
	{
		...
		$url = "http://$this->Xively/users/$user";
		return $this->_getRequest($url);
	}
...
//	{		
	...
	//	{	
	//		echo("passed if funcion curl-init");
	//		return $this->_curl($url, true);
			
	//	}
	//	elseif(function_exists('file_get_contents') && ini_get('allow_url_fopen'))
	//	{	echo("passed if function file_get");
	...
	{		
		...
		{	echo("passed if function curl init");
			return $this->_curl($url, true);
